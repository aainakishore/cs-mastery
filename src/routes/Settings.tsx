  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="sticky top-0 bg-slate-950/90 backdrop-blur border-b border-slate-800 px-4 py-3 flex items-center gap-3">
        <button onClick={() => navigate('/')} className="text-slate-400 hover:text-white text-sm">← Back</button>
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-slate-800 rounded-2xl p-5 space-y-4">
          ...
          <p className="text-slate-400 text-sm">
            Export your progress as JSON, then AirDrop / email it to another device and import there.
          </p>
          <button
            onClick={exportProgress}
            className="w-full flex items-center justify-center gap-2 bg-indigo-700 hover:bg-indigo-600 text-white py-3 rounded-xl font-semibold"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-slate-700 hover:bg-slate-600 text-slate-200 py-3 rounded-xl font-semibold"
          >
        ...
        <div className="bg-red-950/40 border border-red-800 rounded-2xl p-5 space-y-3">
          ...
          <button
            onClick={handleReset}
            className="w-full flex items-center justify-center gap-2 bg-red-700 hover:bg-red-600 text-white py-3 rounded-xl font-semibold"
          >
        ...
        <div className="text-center text-slate-600 text-xs space-y-1">
          <p>CS Mastery v1.0</p>
          <p>No network. No accounts. 100% local.</p>
        </div>
      </div>
    </div>
  )
